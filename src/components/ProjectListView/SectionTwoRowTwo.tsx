...
function SectionTwoRowTwo({bodyInfoTwo}:any) {
    return (
        <div className="w-full flex cursor-pointer">
           <div className="flex justify-center items-center px-2 ml-auto">
              <div className="w-4 h-4 bg-orange-600 rounded-md"></div>
              <p className="text-md font-medium pr-2">
                  {bodyInfoTwo.boards[1].tasks[0].name}
              </p>
           </div>
            ...
            <div className="w-full flex justify-between items-center pl-16">
              <div className="mr-11">
                  <Avatar src={ProfileImage} alt="user image..." />
                    ...
                    <p className="text-xs">
                    {bodyInfoTwo.boards[1].tasks[0].deadline}
                    </p>
...
export default SectionTwoRowTwo;